...
export function Header() {
	...
	return (
		<header
			className={cn('fixed top-0 left-0 right-0 z-50 w-full border-b border-transparent transition-all duration-200', {
				'bg-white/90 supports-[backdrop-filter]:bg-white/90 border-slate-200/50 backdrop-blur-lg shadow-sm':
					scrolled,
			})}
		>
			<nav className="mx-auto flex h-16 w-full max-w-7xl items-center justify-between px-6 lg:px-12">
				<div className="flex items-center gap-6">
					...
					<div className="hidden items-center gap-1 md:flex">
						...
						<Button variant="outline" className="border-slate-200 hover:bg-slate-50 hover:text-slate-900 bg-white text-slate-700" asChild>
			...
			<MobileMenu open={open} className="flex flex-col justify-between gap-2 bg-white">
				...
				<div className="flex flex-col gap-2 pt-4 border-t border-slate-155">
					<Button variant="outline" className="w-full bg-white border-slate-200 hover:bg-slate-50 hover:text-slate-900 text-slate-700" asChild>
