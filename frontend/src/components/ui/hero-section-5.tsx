...
export function HeroSection() {
    ...
    const applyUrl = internshipSettings?.applyUrl || "https://forms.gle/SjDCcUxkjRAGpDRx6"
                    ...
                    <div className="group relative m-auto max-w-7xl px-4 sm:px-6">
                        <div className="relative py-4 w-full">
                            <InfiniteSlider
                                ...
                                {/* 1. Google */}
                                <div className="flex items-center gap-4 px-7 py-4 rounded-2xl bg-white dark:bg-zinc-900 border border-slate-200/90 dark:border-zinc-800/80 transition-all hover:scale-105 hover:shadow-md shadow-xs">
                                    <svg className="size-10 sm:size-11 shrink-0" viewBox="0 0 24 24">
                                        <path fill="#4285F4" d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z"/>
                                        <path fill="#34A853" d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z"/>
                                        <path fill="#FBBC05" d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.06H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.94l2.85-2.22.81-.63z"/>
                                        <path fill="#EA4335" d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.06l3.66 2.84c.87-2.6 3.3-4.52 6.16-4.52z"/>
                                    </svg>
                                    <span className="text-lg sm:text-xl font-bold text-slate-900 dark:text-zinc-100 tracking-tight">Google</span>
                                </div>

                                {/* 2. OpenAI */}
                                <div className="flex items-center gap-4 px-7 py-4 rounded-2xl bg-white dark:bg-zinc-900 border border-slate-200/90 dark:border-zinc-800/80 transition-all hover:scale-105 hover:shadow-md shadow-xs">
                                    <svg className="size-10 sm:size-11 shrink-0 text-slate-900 dark:text-white fill-current" viewBox="0 0 24 24">
                                    ...
                                    <span className="text-lg sm:text-xl font-bold text-slate-900 dark:text-zinc-100 tracking-tight">OpenAI</span>
                                </div>

                                {/* 3. NVIDIA */}
                                <div className="flex items-center gap-4 px-7 py-4 rounded-2xl bg-white dark:bg-zinc-900 border border-slate-200/90 dark:border-zinc-800/80 transition-all hover:scale-105 hover:shadow-md shadow-xs">
                                    <svg className="size-10 sm:size-11 shrink-0 text-[#76B900] fill-current" viewBox="0 0 24 24">
                                    ...
                                    <span className="text-lg sm:text-xl font-bold text-slate-900 dark:text-zinc-100 tracking-tight">NVIDIA</span>
                                </div>

                                {/* 4. Stripe */}
                                <div className="flex items-center gap-4 px-7 py-4 rounded-2xl bg-white dark:bg-zinc-900 border border-slate-200/90 dark:border-zinc-800/80 transition-all hover:scale-105 hover:shadow-md shadow-xs">
                                    <svg className="h-9 sm:h-10 w-auto text-[#635BFF] fill-current" viewBox="0 0 60 25">
                                    ...
                                    <span className="text-lg sm:text-xl font-bold text-slate-900 dark:text-zinc-100 tracking-tight">Stripe</span>
                                </div>
                                ...
                                <div className="flex items-center gap-4 px-7 py-4 rounded-2xl bg-white dark:bg-zinc-900 border border-slate-200/90 dark:border-zinc-800/80 transition-all hover:scale-105 hover:shadow-md shadow-xs">
                                    ...
                                    <span className="text-lg sm:text-xl font-bold text-slate-900 dark:text-zinc-100 tracking-tight">GitHub</span>
                                </div>
                                ...
                                <div className="flex items-center gap-4 px-7 py-4 rounded-2xl bg-white dark:bg-zinc-900 border border-slate-200/90 dark:border-zinc-800/80 transition-all hover:scale-105 hover:shadow-md shadow-xs">
                                    ...
                                    <span className="text-lg sm:text-xl font-bold text-slate-900 dark:text-zinc-100 tracking-tight">Microsoft</span>
                                </div>

                                {/* 7. Laravel */}
                                <div className="flex items-center gap-4 px-7 py-4 rounded-2xl bg-white dark:bg-zinc-900 border border-slate-200/90 dark:border-zinc-800/80 transition-all hover:scale-105 hover:shadow-md shadow-xs">
                                    <svg className="size-10 sm:size-11 shrink-0 text-[#FF2D20] fill-current" viewBox="0 0 24 24">
                                    ...
                                    <span className="text-lg sm:text-xl font-bold text-slate-900 dark:text-zinc-100 tracking-tight">Laravel</span>
                                </div>

                                {/* 8. AWS */}
                                <div className="flex items-center gap-4 px-7 py-4 rounded-2xl bg-white dark:bg-zinc-900 border border-slate-200/90 dark:border-zinc-800/80 transition-all hover:scale-105 hover:shadow-md shadow-xs">
                                    <svg className="size-10 sm:size-11 shrink-0 text-[#FF9900] fill-current" viewBox="0 0 24 24">
                                    ...
                                    <span className="text-lg sm:text-xl font-bold text-slate-900 dark:text-zinc-100 tracking-tight">AWS</span>
                                </div>

                                {/* 9. React */}
                                <div className="flex items-center gap-4 px-7 py-4 rounded-2xl bg-white dark:bg-zinc-900 border border-slate-200/90 dark:border-zinc-800/80 transition-all hover:scale-105 hover:shadow-md shadow-xs">
                                    <svg className="size-10 sm:size-11 shrink-0 text-[#61DAFB] fill-current" viewBox="0 0 24 24">
                                    ...
                                    <span className="text-lg sm:text-xl font-bold text-slate-900 dark:text-zinc-100 tracking-tight">React</span>
                                </div>
