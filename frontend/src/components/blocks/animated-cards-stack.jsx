...
export const CardStack = ({
  ...
  return (
    <div className={cn("relative h-[310px] w-full max-w-[420px] mx-auto", className)}>
      {cards.map((card, index) => {
        return (
          <motion.div
            key={card.id}
            className="absolute bg-white/95 backdrop-blur-md size-full rounded-2xl p-6 md:p-8 shadow-[0_8px_30px_rgb(0,0,0,0.08)] border border-slate-200/50 flex flex-col justify-between"
            style={{
